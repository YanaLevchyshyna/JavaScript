...
//   console.log('deliverPizza:  ', `Delivering pizza ${pizzaName}.`);
// });
// // Change code below this line

// makePizza('Ultracheese', function eatPizza(pizzaName) {
//   console.log('eatPizza:  ', `Eating pizza ${pizzaName}`);
// });
...
// ----------T   A  S  K ---------13---Функція з побічними ефектами----
...
// -----T  A  S  k-----20------Filter-унікальні елементи-+++--flatMap()--
...
// -----T  A  S  k-----21-----Filter-уМасив об'єктів---
...
// --------T  A  S  k-----22-----Filter-уМасив об'єктів---
...
// --------T  A  S  k-----23-----Filter-Масив об'єктів---
...
// --------T  A  S  k-----24-----Filter-Масив об'єктів---
...
// --------T  A  S  k-----25-----Filter-Масив об'єктів-- +++-Ланцюжки методів-
...
//     .filter(
//       (friend, index, getFriends) => getFriends.indexOf(friend) === index
//     );
// };

// --------T  A  S  k-----26-----Filter-Масив об'єктів--
...
//   return users.filter((user) => user.isActive); // поверне хто активний

//   return users.filter((user) => !user.isActive);  // поверне хто не активний
// };

// --------T  A  S  k-----28-----Метод find()--
...
// );
// console.log('author:  ', sortedByAuthorName);
...
//   const sortedBalance = [...users].sort(
//     (prevValue, nextValue) => prevValue.balance - nextValue.balance
//   );
//   console.log(sortedBalance);
//   return sortedBalance;
// };

// --------------T  A  S  k---------43-------Метод sort()--------

// const allFriends = [...users];

// const sortByDescendingFriendCount = (users) => {
//   const allFriends = [...users].sort(
//     (prevValue, nextValue) =>
//       nextValue.friends.length - prevValue.friends.length
//   );

//   return allFriends;
// };

// --------------T  A  S  k---------44-------Метод sort()--------

// const sortByName = (users) => {
//   const sortedByName = [...users].sort((prevName, nextName) =>
//     prevName.name.localeCompare(nextName.name)
//   );
//   return sortedByName;
// };

// --------------T  A  S  k---------45-------Метод filter, map, sort--------
...
// --------------T  A  S  k---------46-------Метод filter, map, sort--------
...
// -----T  A  S  k---47-----Filter-унікальні елементи-+--flatMap()-+sort();-
